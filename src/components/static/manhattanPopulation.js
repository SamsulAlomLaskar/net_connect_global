export const data = [
  ...
  },
  {
    ...
    title: "The Uptown/Downtown Divide",
    description:
      "Shown here are all neighborhoods north of 59th Street. At “peak Manhattan population” (Wednesdays around 2 pm), this region holds an estimated 1.25 million people and constitutes over half of the land area of Manhattan (about 12 square miles, not including Central Park). The density of about 100,000 persons per square mile (~40,000 persons per square kilometer) at this time is on par with that of the densest residential areas of Paris (11th arrondissement) and Taipei (Yonghe District).",
    visible_districts: [
      "none",
      "none",
      "none",
  ...
  },
  {
    ...
    title: "Midtown & FiDi: Population Magnets",
    description:
      "The large multiplicative increases in the daytime versus the overnight populations for FiDi and Midtown are a consequence of the low residential counts for both of these neighborhoods. Shown below are Community Districts 1 and 5 at their lowest estimated populations. While Midtown and FiDi may collectively host nearly a million people every workday, these neighborhoods are actually home to less than 80,000 residents.",
    visible_districts: [
      "checked",
      "none",
      "none",
